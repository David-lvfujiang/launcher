package com.fenda.calendar.utils;
...
public class LunarSolarConverter {
    ...
    public static String lunarYearToGanZhi(int lunarYear) {
        ...
        final String[] shengXiao = {"鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"};
        return tianGan[(lunarYear - 4) % 10] + diZhi[(lunarYear - 4) % 12] + shengXiao[(lunarYear - 4) % 12] + "年";
    }
    ...
    public static Lunar SolarToLunar(Solar solar) {
        ...
        lunar.lunarYearToJiaZi = lunarYearToGanZhi(lunarY);
