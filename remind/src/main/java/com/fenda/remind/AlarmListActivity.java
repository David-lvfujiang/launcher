...
//
//import com.fenda.common.bus.EventBusUtils;
//import com.fenda.lucher.adapter.AlarmAdatpter;
//import com.fenda.lucher.bean.AlarmBean;
//import com.fenda.lucher.net.Constant;
//
...
//
//    private AlarmAdatpter mAdatpter;
...
//        alarmBeans = getIntent().getParcelableArrayListExtra(Constant.ALARM.ALARM_LIST);
//        alarmType   = getIntent().getStringExtra(Constant.ALARM.ALARM_TYPE);
//        initData();
//        addListener();
//        countDownTime();
//
...
//        if (Constant.ALARM.DELETE_REMIND.equals(alarmType)){
...
//        mAdatpter = new AlarmAdatpter(this, alarmBeans);
//        alarmList.setAdapter(mAdatpter);
//    }
//
//
...
//        if (bean.getType() == Constant.ALARM.DELETE_ALARM){
//            if (alarmBeans != null){
