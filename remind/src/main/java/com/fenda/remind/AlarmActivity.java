...
//        imgRightTwo = findViewById(R.id.imgRightTwo);
...
//        if (Constant.ALARM.CREATE_REMIND.equals(type)) {
...
//            }
//            tvDate.setText(getResources().getString(R.string.alarm_time_source, mTime, alarmBean.getPeriod()));
//            countDownTime();
//        } else if (Constant.ALARM.ALARM_REMIND.equals(type)) {
...
//        if (bean.getType() == Constant.ALARM.CLOSE_ALARM){
//            this.finish();
//        }
//
//    }
