...
public class MsgTimeoutTimerManager {
     ...
     * @param msg
     */
    public void add(BaseTcpMessage msg) {
        ...
        BaseTcpMessage handshakeMsg = imsClient.getHandshakeMsg();
        ...
        String msgId = String.valueOf(msg.getHead().getMsgId());
