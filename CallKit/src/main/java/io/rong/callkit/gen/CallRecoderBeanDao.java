...
public class CallRecoderBeanDao extends AbstractDao<CallRecoderBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CallTime = new Property(5, long.class, "callTime", false, "CALL_TIME");
        ...
        public final static Property CallStatus = new Property(8, int.class, "callStatus", false, "CALL_STATUS");
        public final static Property CallMode = new Property(9, int.class, "callMode", false, "CALL_MODE");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CALL_RECODER_BEAN\" (" + //
                ...
                "\"PHONE\" TEXT," + // 3: phone
                "\"ICON\" TEXT," + // 4: icon
                "\"CALL_TIME\" INTEGER NOT NULL ," + // 5: callTime
                "\"COMMUNICATE_TIME\" INTEGER NOT NULL ," + // 6: communicateTime
                "\"CALL_TYPE\" INTEGER NOT NULL ," + // 7: callType
                "\"CALL_STATUS\" INTEGER NOT NULL ," + // 8: callStatus
                "\"CALL_MODE\" INTEGER NOT NULL );"); // 9: callMode
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, CallRecoderBean entity) {
        ...
        stmt.bindLong(6, entity.getCallTime());
        stmt.bindLong(7, entity.getCommunicateTime());
        stmt.bindLong(8, entity.getCallType());
        stmt.bindLong(9, entity.getCallStatus());
        stmt.bindLong(10, entity.getCallMode());
    }
    ...
    public CallRecoderBean readEntity(Cursor cursor, int offset) {
        CallRecoderBean entity = new CallRecoderBean( //
            ...
            cursor.getLong(offset + 5), // callTime
            cursor.getLong(offset + 6), // communicateTime
            cursor.getInt(offset + 7), // callType
            cursor.getInt(offset + 8), // callStatus
            cursor.getInt(offset + 9) // callMode
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, CallRecoderBean entity, int offset) {
        ...
        entity.setCallTime(cursor.getLong(offset + 5));
        entity.setCommunicateTime(cursor.getLong(offset + 6));
        entity.setCallType(cursor.getInt(offset + 7));
        entity.setCallStatus(cursor.getInt(offset + 8));
        entity.setCallMode(cursor.getInt(offset + 9));
     }
